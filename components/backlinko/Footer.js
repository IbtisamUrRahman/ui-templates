const Footer = () => {
    return ( 
        <footer class="bg-gray-800 text-gray-200 body-font -mr-14 lg:-mr-0">
  <div class=" container px-10 py-10 mx-auto flex lg:items-start flex-row flex-nowrap">
    <div class="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
      ...
      <p class="text-sm font-medium text-gray-200 mt-6">Next-level SEO training and build link strategies</p>
    </div>
    <div class="flex-grow flex flex-nowrap md:pl-20 -mb-10 mt-0 md:text-left text-center">
      <div class="lg:w-1/3 md:w-1/2 w-full px-4">
        <h2 class="title-font font-medium text-gray-200 tracking-widest text-sm mb-3">Learn</h2>
        <nav class="list-none mb-10">
          <li>
            <a class="text-gray-400 hover:text-gray-200 cursor-pointer">Blog</a>
          </li>
          <li>
            <a class="text-gray-400 hover:text-gray-200 cursor-pointer">Newsletter</a>
          </li>
          <li>
            <a class="text-gray-400 hover:text-gray-200 cursor-pointer">Training</a>
          </li>
        </nav>
      </div>
      <div class="lg:w-1/3 md:w-1/2 w-full px-4">
        <h2 class="title-font font-medium text-gray-200 tracking-widest text-sm mb-3">Company</h2>
        <nav class="list-none mb-10">
          <li>
            <a class="text-gray-400 hover:text-gray-200 cursor-pointer">Home</a>
          </li>
          <li>
            <a class="text-gray-400 hover:text-gray-200 cursor-pointer">About</a>
          </li>
          <li>
            <a class="text-gray-400 hover:text-gray-200 cursor-pointer">Contact</a>
          </li>
        </nav>
      </div>
      <div class="lg:w-1/3 md:w-1/2 w-full px-4">
        <h2 class="title-font font-medium text-gray-200 tracking-widest text-sm mb-3">Connect</h2>
        <nav class="list-none mb-10">
