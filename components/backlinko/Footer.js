const Footer = () => {
    return ( 
        <footer class="bg-white sm:bg-gray-800 body-font -mr-99 sm:-mr-14 lg:-mr-16 ml-14 sm:ml-0">
  <div class=" container px-4 md:px-10 py-10 mx-auto flex lg:items-start flex-row flex-nowrap">
    <div class="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
      ...
      <p class="font-medium text-xl sm:text-base text-gray-900 sm:text-gray-200 mt-6">Next-level SEO training and build link strategies</p>
    </div>
    <div class="flex-grow flex flex-nowrap md:pl-20 -mb-10 mt-0 md:text-left text-center">
      <div class="lg:w-1/3 md:w-1/2 w-full px-4">
        <h2 class="title-font font-bold sm:font-medium text-xl sm:text-base text-gray-900 sm:text-gray-200 tracking-widest  mb-3">Learn</h2>
        <nav class="list-none mb-10">
          <li>
            <a class="text-xl sm:text-base text-gray-900 sm:text-gray-400 hover:text-gray-200 cursor-pointer">Blog</a>
          </li>
          <li>
            <a class="text-xl sm:text-base text-gray-900 sm:text-gray-400 hover:text-gray-200 cursor-pointer">Newsletter</a>
          </li>
          <li>
            <a class="text-xl sm:text-base text-gray-900 sm:text-gray-400 hover:text-gray-200 cursor-pointer">Training</a>
          </li>
        </nav>
      </div>
      <div class="lg:w-1/3 md:w-1/2 w-full px-4">
        <h2 class="title-font font-bold sm:font-medium text-xl sm:text-base text-gray-900 sm:text-gray-200 tracking-widest mb-3">Company</h2>
        <nav class="list-none mb-10">
          <li>
            <a class="text-xl sm:text-base text-gray-900 sm:text-gray-400 hover:text-gray-200 cursor-pointer">Home</a>
          </li>
          <li>
            <a class="text-xl sm:text-base text-gray-900 sm:text-gray-400 hover:text-gray-200 cursor-pointer">About</a>
          </li>
          <li>
            <a class="text-xl sm:text-base text-gray-900 sm:text-gray-400 hover:text-gray-200 cursor-pointer">Contact</a>
          </li>
        </nav>
      </div>
      <div class="lg:w-1/3 md:w-1/2 w-full px-4">
        <h2 class="title-font font-bold sm:font-medium text-xl sm:text-base text-gray-900 sm:text-gray-200 tracking-widest mb-3">Connect</h2>
        <nav class="list-none mb-10">
  ...
  <div class="hidden sm:block bg-gray-800">
    <div class="container mx-auto py-4 px-10 flex justify-between flex-wrap flex-col sm:flex-row ">
      <p class="text-gray-500 text-sm text-center sm:text-left">© 2021 Backlinko is a Trademark of Backlinko LLC —
      </p>
    <a href="https://twitter.com/knyttneve" rel="noopener noreferrer" class="text-gray-200 ml-1" target="_blank">Terms of Privacy</a>
    </div>
  </div>
</footer>
     );
