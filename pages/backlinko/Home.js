        ...
        <div className="container xl:mx-auto pt-5 lg:mb-5 h-auto w-full lg:w-full xl:w-5/6 3xl:w-3/6">
            <header>
                <div className="flex items-center justify-between sm:ml-10 sm:mr-3 pl-14 pr-8 sm:pl-8 sm:pr-0">
                   ...
                   <AiOutlineMenu className="block text-gray-500 h-6 w-6 lg:hidden"/>
            ...
            <section>
                <div className="h-80 lg:h-97 xl:h-99 w-full flex items-start ml-8 mt-20 overflow-hidden">
                    <div className="w-1/2 pl-8 sm:-pt-10">
                        <h1 className="text-gray-900 font-extrabold text-4xl sm:text-4xl lg:text-5xl lg:pb-4 xl:text-5xl capitalize lg:tracking-wide sm:leading-snug">Get exclusive SEO tips that <br className="hidden sm:block md:hidden"/> i only share with email subscribers</h1>
                        <div className="hidden bg-white h-28 lg:h-30 xl:h-36 lg:w-full 2xl:w-5/6 w-5/6 rounded-lg border border-gray-200 lg:flex items-start p-4 mt-8">
                          ...
                          <div className="ml-4">
                              <p className="font-medium text-sm lg:text-base xl:text-lg text-gray-500 lg:leading-relaxed xl:leading-loose">"I thought the blog was good. But the newsletter? <br className="block lg:hidden" /> Even better !"</p>
                    ...
                    <div className="w-1/2 2xl:pl-20 ml-12">
