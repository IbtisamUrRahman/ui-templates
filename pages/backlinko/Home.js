...
const Home = () => {
    return ( 
        ...
        <div className="container lg:mx-auto pt-5 lg:mb-5 h-auto w-full lg:w-5/6 xl:w-5/6">
            <header>
        ...
        <main>
            <div className="h-auto my-10">
                <div className="container mx-auto w-full lg:w-5/6 xl:w-4/6">
            ...
            <div className="h-auto my-6 -mr-12 lg:-mr-0">
                <div className="container mx-auto pb-4 w-full lg:w-5/6 xl:w-4/6">
