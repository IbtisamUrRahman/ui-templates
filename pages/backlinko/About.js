...
const About = () => {
    return ( 
        ...
        <div className="h-auto pl-4 lg:pl-0 -mr-99 sm:-mr-12 lg:-mr-24 mt-6">
            <div className="bg-green-500 container mx-auto pt-5 lg:mb-5 h-96 w-full lg:w-5/6 3xl:w-3/6">
                <div className=" rounded-lg px-24 pt-12 mr-3 sm:mr-0">
                ...
                <div className="flex justify-end">
                    <GoTriangleUp className="h-20 w-20 text-black transform -rotate-45 -mt-7 -mr-14"/>
                    <GoTriangleDown className="h-24 w-20 text-white transform -rotate-45 -mt-3 -mr-8"/>
                </div>
            </div>
        </div>
            ...
            <div className="container mx-auto pt-5 lg:mb-5 h-auto w-full lg:w-5/6 3xl:w-3/6">
                ...
                <section class="text-gray-600 body-font">
                    <div class="container mx-auto flex px-5 pt-24 pb-24 md:flex-row flex-col items-start">
                        ...
                        <a className="bg-blue-500 px-3 py-1 text-lg text-white rounded-md mr-4 cursor-pointer hover:bg-blue-400">
                            Follow @backlinko
                        </a>
